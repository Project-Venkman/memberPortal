...
import { vBar, Crown } from '@components/Chive';
import { Api } from '@pages/scripts/API';

const GoldBar: React.FC<ChiveProps> = (props) => {
    ...
    return (
        <div className="container max-w-none h-screen overflow-y-auto mx-auto">
            <Web3ModalComponent />
            ...
            <div className="h-[20%] flex justify-center items-center">
                <button
                    ...
                    className="sm:w-full md:w-[30%] p-5 border-2 border-white text-white w-[20%] text-center text-2xl hover:bg-white hover:text-black transition-colors duration-300"
                >
                    Enter Data
                </button>
            </div>
