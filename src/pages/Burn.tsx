...
export const Burn: React.FC<BurnProps> = (props) => {
	...
	useEffect(() => {
		console.log("BM Burns", burns)
	}, [burns])

	return (
		<BurnPage className={"max-w-[1920px] px-32 mt-16"} id={"burn-page"}>
			<div>
				<button className={"font-barlow uppercase tracking-[1.5px] text-[18px] leading-[28.8px] text-white antialiased hover:animate-pulse hover:text-gold"} onClick={handleHomeClick} >Home</button>
			</div>
