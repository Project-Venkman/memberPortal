...
export const ClaimCard: React.FC<ClaimCardProps> = (props) => {
    ...
    const claims: Array<Claim> = useSelector(
        (state: RootState) => state.claimAssets as Array<Claim>
    );
            ...
            <ClaimInfoContainer id={'Claim-info-container'}>
                <ClaimDataContainer id={'Claim-data-container'}>
                    <ClaimDataHeader id={'Claim-header-info'}>
                        <ClaimName id={'Claim-name'}>
                            {claim.name + ' ' + claim.tokenId}
                        </ClaimName>
                    </ClaimDataHeader>
                    <ClaimImageContainer>
