...
import {
	ResultPageNavListItem, ResultPageNavMobile
} from "@styles/index";
...
export const NavbarMobile: React.FC<NavBarProps> = (props) => {
	...
	const navMobileButtons: Array<string> = ["media", "claim", "events"];
	...
	return (
		<ResultPageNavMobile id="resultpagenavmobile">
			...
			<ul hidden={!showMenu} className={"bg-black w-full relative mt-[100px] sm:mt-[15%] h-full"}>
				...
				<ResultPageNavListItem>
					<button className={"uppercase font-barlow font-black text-[20px] text-gray-700 hover:text-gray-500 text-start"} onClick={handleMobileClick}>Logout</button>
				</ResultPageNavListItem>
			</ul>
		</ResultPageNavMobile>
	)
