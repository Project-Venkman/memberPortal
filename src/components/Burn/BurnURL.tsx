...
import { Api, HMApi } from "@scripts/API";
...
export const BurnURL: React.FC<BurnURLProps> = (props) => {
	...
	const handleBurnClick = async () => {
		...
		await Api.asset.updateOwner("00000004-0000-0000-0000-000000000004", "913", "00000000-0000-0000-0000-000000000000").then(
			(res) => {
				//location.href = `https://opensea.io/assets/ethereum/${options.contractAddress}/${options.tokenId}/transfer`;
			}
		)
	...
	return (
		<BurnURLContainer>
			...
			<button onClick={handleBurnClick}>{"Click here to burn"}</button>
		</BurnURLContainer>
	)
}
